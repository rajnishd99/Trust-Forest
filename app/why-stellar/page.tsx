    ...
    <>
      ...
      <section className="px-5 pb-16 sm:px-8">
        <div className="mx-auto grid max-w-7xl gap-5 md:grid-cols-3">
          ...
          <StatCounter value={1} suffix=" admin" label="Decision authority" />
        </div>
      </section>
          ...
          {[
            {
              ...
              text: "Planters and the admin do not need to wait through slow settlement loops.",
            },
            {
              icon: Coins,
            ...
            },
            {
              ...
              text: "Claim status, reward flow, and admin decisions can be surfaced to anyone.",
            },
          ].map((item, index) => (
